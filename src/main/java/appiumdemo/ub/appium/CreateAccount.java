...
public class CreateAccount {
	...
	By element_country_name_selector = new By.ById(
			"com.facebook.katana:id/country_name_selector");
	By element_finish_button_next = new By.ById(
			"com.facebook.katana:id/finish_button");
	By element_switch_to_email_button = new By.ById(
			"com.facebook.katana:id/switch_to_email_button");
	By element_country_search_edit_text = new By.ById(
			"com.facebook.katana:id/country_search_edit_text");
	...
	By element_dialog_container = new By.ById(
			"com.android.packageinstaller:id/dialog_container");
	By element_permission_message = new By.ById(
			"com.android.packageinstaller:id/permission_message");
	By element_permission_allow_button = new By.ById(
			"com.android.packageinstaller:id/permission_allow_button");
	By element_permission_deny_button = new By.ById(
			"com.android.packageinstaller:id/permission_deny_button");
	By element_runtime_permission_title = new By.ById(
			"com.facebook.katana:id/runtime_permission_title");
	By element_first_name_input = new By.ById(
			"com.facebook.katana:id/first_name_input");
	By element_last_name_input = new By.ById(
			"com.facebook.katana:id/last_name_input");
	By element_birthday_confirm_button = new By.ById(
			"com.facebook.katana:id/button1");
	By element_birthday_alert_title = new By.ById(
			"com.facebook.katana:id/alertTitle");
	By element_gender_male = new By.ById("com.facebook.katana:id/gender_male");
	By element_gender_female = new By.ById(
			"com.facebook.katana:id/gender_female");
	By element_password_input = new By.ById(
			"com.facebook.katana:id/password_input");
	By element_terms_and_conditions_title = new By.ById(
			"com.facebook.katana:id/title");
	By element_finish_button = new By.ById(
			"com.facebook.katana:id/finish_button");
	By element_finish_without_contacts = new By.ById(
			"com.facebook.katana:id/finish_without_contacts");
	...
	public void verifyDialogContainerIsDisplayed() {
		Assert.assertTrue(UiHelper
				.isVisibleAndDisplayed(element_dialog_container));
	}

	public void verifyPermissionMessagIsCorrect() {
		Assert.assertEquals(UiHelper.getText(element_permission_message),
				dialog_container_text1);
	}
	...
	public void verifyRuntimePermissionMessageIsCorrect() {
		Assert.assertEquals(UiHelper.getText(element_runtime_permission_title),
				dialog_container_text2);
	}

	public void verifyHeaderTextIsCorrect() {
		if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text3)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text3);
		} else if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text1)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text2);
		} else if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text4)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text4);
		} else if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text5)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text5);
		} else if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text6)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text6);
		} else if (UiHelper.matchedToHeader(element_header_text,
				dialog_container_text7)) {
			Assert.assertEquals(UiHelper.getText(element_header_text),
					dialog_container_text7);
		}
	...
	public void veifyBirthdayHeaderText() {
		Assert.assertEquals(UiHelper.getText(element_birthday_alert_title),
				dialoag_container_birthdaytxt);
	}
	...
	public void enterUserData() {
		...
		if (UiHelper.getText(element_header_text).equalsIgnoreCase(
				dialog_container_text5)) {
			this.selectCountry();
			this.enterMoibleNumber();
		} else if (UiHelper.getText(element_header_text).equalsIgnoreCase(
				dialog_container_text3)) {
			this.enterFirstName();
			this.enterLastName();
		} else if (UiHelper.getText(element_header_text).equalsIgnoreCase(
	...
	public void verifyTermsAndConditionPageIsDisplayed() {
		Assert.assertEquals(
				UiHelper.getText(element_terms_and_conditions_title),
	...
	public void verifySignupWithoutUploadingMyContactsButtonIsDisplayed() {
		Assert.assertEquals(UiHelper.getText(element_finish_without_contacts),
				finish_without_contacts_button_text, "Passed");
	}
